        ...
        <form onSubmit={handleSubmit} className="flex-1 flex flex-col min-h-0">
          ...
          <div className="p-6 border-t border-gray-100 bg-white flex gap-3 shrink-0">
            <button
              ...
              onClick={onClose}
              disabled={loading}
              className="flex-1 py-2.5 border border-gray-200 rounded-lg text-sm text-gray-600 hover:bg-gray-50 disabled:opacity-50 min-h-[44px]"
            >
              Cancel
            </button>
            <button
              type="submit"
              disabled={loading}
              className="flex-1 py-2.5 bg-black text-white rounded-lg text-sm font-medium hover:bg-gray-900 flex items-center justify-center gap-1.5 disabled:opacity-50 min-h-[44px]"
            >
